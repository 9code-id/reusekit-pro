...
Color secondaryColor = Color(0xFFE5E7EB);
Color successColor = Color(0xFF10B981);
Color dangerColor = Color(0xFFEF4444);
Color infoColor = Color(0xFF3B82F6);
Color warningColor = Color(0xFFF59E0B);
Color disabledBoldColor = Color(0xFF6B7280);
Color disabledColor = Color(0xFF9CA3AF);
Color disabledOutlineBorderColor = Color(0xFFD1D5DB);
...
Color textSecondaryColor = Colors.grey[700]!;
final spXxs = 4.0;
final spXs = 6.0;
final spSm = 8.0;
final spMd = 12.0;
...
final cardHeaderMaxHeight = 42.0;

// textfield max height
final textfieldMaxHeight = 36.0;
